...
public class ServerData {
    ...
    public static Map<Integer, SwengCardMagic> createMagicServerMap() {
    ...
    public static Map<Integer, SwengPokemonCard> createPokemonServerMap() {
    ...
    public static Map<Integer, SwengYuGiOhCard> createYuGiOhServerMap() {
    ...
    public static List<SwengCard> createMagicServerList() {
        return new ArrayList<>(createMagicServerMap().values());
    }
    public static List<SwengCard> createPokemonServerList() {
        return new ArrayList<>(createPokemonServerMap().values());
    }
    public static List<SwengCard> createYuGiOhServerList() {
        return new ArrayList<>(createYuGiOhServerMap().values());
    }
    public static List<OwnedCard> createOwnedCardServerList(int n) {
    ...
    public static List<OwnedCardFetched> createOwnedCardWithNameServerList(int n) {
        return createOwnedCardServerList(n).stream().map(oCard -> new OwnedCardFetched(oCard, "test")).collect(Collectors.toList());
    }
}